(function(ng) {	
    ...
    var busquedaComponent = {
    		...
    		$inject:['$location', 'BASE_SRC', 'AseguradoraService', '$mdDialog'],
    		require: {
            	parent:'^busquedaApp'
            },
            bindings:{
    ...
    busquedaComponent.controller = function busquedaComponentController($location, BASE_SRC, AseguradoraService, $mdDialog){
    	var vm=this;
    	var json = {};
    	...
    	vm.gridOptions = {
    		    ...
    		    columnDefs: [
    		      {field: 'ID_COMPANIA', 
      		      ...
      		      {field: 'NO_COMPANIA', displayName: 'Reaseguradora', cellTooltip: function(row){return row.entity.NO_COMPANIA}},
      		      {field: 'NU_CIF', displayName: 'NIF/NIE/CIF', cellTooltip: function(row){return row.entity.NU_DOCUMENTO}},
    	...
    	this.loadTemplate = function() {
			return BASE_SRC+"busqueda/busqueda.view/admin/busqueda.reaseguradoras.html";
    	}
    	...
    	//Abrir pantalla de nueva reaseguradora
    	vm.nuevaReaseguradora = function(){
    		vm.numDetalles.push({});
            vm.active = vm.numDetalles.length;
    	}
    ...
    ng.module('App').component('busquedaReaseguradoras', Object.create(busquedaComponent));
