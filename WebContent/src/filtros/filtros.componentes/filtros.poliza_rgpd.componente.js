(function(ng) {	
    ...
    var filtrosPolizasRgpdComponent = {
    		controllerAs: '$ctrl',
    ...
    filtrosPolizasRgpdComponent.controller = function filtrosPolizasRgpdComponentComponentController($location, $routeParams, sharePropertiesService, BusquedaService, TiposService, UsuarioService, ColectivoService, uiGridConstants, BASE_SRC,$mdDialog, AseguradoraService, constantsTipos){
    	var vm=this;
    	var json = {};
    	...
    	this.loadTemplate=function(){
    		return BASE_SRC+"filtros/filtros.view/filtros.poliza_rgpd.html";
    	}
...
//                    vm.form.LST_COLECTIVOS.value.push(colectivo.ID_TIPO_POLIZA);
    ...
    ng.module('App').component('filtrosPolizasRgpdApp', Object.create(filtrosPolizasRgpdComponent));    
})(window.angular);