(function(ng) {	
    ...
    var filtrosMovimientosEconomicosComponent = {
    		controllerAs: '$ctrl',
    ...
    filtrosMovimientosEconomicosComponent.controller = function filtrosMovimientosEconomicosComponentController($location, sharePropertiesService, BusquedaService, TiposService, ColectivoService, BASE_SRC,$mdDialog, constantsTipos){
    	var vm=this;
    	var json = {};
    	vm.vista = 1;
		vm.tipos = {};
    	...
    	this.$onInit = function(){
            ...
            if (nuSiniestroUrl != null && nuSiniestroUrl != "") {
                ...
                vm.form.LST_MOVS_ECONOMICOS = [];
                
                vm.form.NU_SINIESTRO = {
                    value: nuSiniestroUrl
                }
                
                vm.buscar('movimientoSiniestros');
            }
    	...
    	this.loadTemplate=function(){
    		return BASE_SRC+"filtros/filtros.view/filtros.movimientosEconomicos.html";
    	}
    	
    	vm.buscar = function(tipo){
			setTimeout(function() {
				angular.forEach(vm.form, function(value, key) {
					if((value.value == "" || value.value==null) && key != 'OPOLIZA' && key != 'LST_MOVS_ECONOMICOS'){
							delete vm.form[key];
						}
					});
...
//                    vm.form.LST_COLECTIVOS.value.push(colectivo.ID_TIPO_POLIZA);
    ...
    ng.module('App').component('filtrosMovimientosEconomicosApp', Object.create(filtrosMovimientosEconomicosComponent));    
})(window.angular);