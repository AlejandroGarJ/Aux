(function(ng) {	
    ...
    var filtrosPolizasTiperComponent = {
    		controllerAs: '$ctrl',
    ...
    filtrosPolizasTiperComponent.controller = function filtrosPolizasTiperComponentComponentController($location, $routeParams, sharePropertiesService, BusquedaService, TiposService, UsuarioService, ColectivoService, uiGridConstants, BASE_SRC,$mdDialog, AseguradoraService, constantsTipos){
    	var vm=this;
    	var json = {};
...
//			});
    	...
    	this.loadTemplate=function(){
    		return BASE_SRC+"filtros/filtros.view/filtros.poliza_tiper.html";
    	}
...
//                    vm.form.LST_COLECTIVOS.value.push(colectivo.ID_TIPO_POLIZA);
    ...
    ng.module('App').component('filtrosPolizasTiperApp', Object.create(filtrosPolizasTiperComponent));    
})(window.angular);