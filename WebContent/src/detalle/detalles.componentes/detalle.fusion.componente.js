(function(ng) {	
    ...
    detalleFusionComponent.controller = function detalleFusionComponentControler($q, $scope, $location, $mdDialog, uiGridConstants, MovilService,  BASE_SRC, $window){
    	var vm=this;
    	...
    	this.loadTemplate = function() {
            return BASE_SRC + "detalle/detalles.views/detalle.fusion.html";
    	}
...
//				    	}
    ...
    ng.module('App').component('detalleFusion', Object.create(detalleFusionComponent));
